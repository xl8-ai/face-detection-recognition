...
# docker run --rm -d -p 10002:10002 -e BATCH_SIZE=6 -e REC_BATCH_SIZE=6 --gpus all leo/face-detection-recognition-cuda --gpu_id=0 --port=10002 --input_size=160
# docker run --rm -d -p 10003:10002 -e BATCH_SIZE=6 -e REC_BATCH_SIZE=6 --gpus all leo/face-detection-recognition-cuda --gpu_id=1 --port=10003 --input_size=160
